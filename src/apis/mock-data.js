export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'VanKietDev MERN Stack Board 123',
    ...
    columns: [
      ...
      },
      {
        ...
        /**
           * Video 37.2: Xử lý lỗi logic của thư viện Dnd-kit khi một Column không có dữ liệu:
           *
           ...
           *
           * - Kỹ hơn nữa, ở các bước tiếp theo sẽ kết hợp phân tích API từ Back-end vào hệ thống. (Hiện tại dùng dữ liệu giả/mocked)
           */
