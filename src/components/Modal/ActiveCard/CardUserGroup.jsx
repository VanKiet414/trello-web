...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
   ...
   * Vì thế dựa vào mảng board.FE_allUsers và card.memberIds rồi chúng ta tạo ra một mảng FE_CardMembers chứa đủ thông tin của User để hiển thị ra ngoài giao diện,
   * bởi mặc định trong card chỉ lưu đám Id của User thôi (memberIds)
   */
  ...
  // là xóa khỏi card (REMOVE) hoặc thêm vào card (ADD)
